...
@section('content')
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-6 col-lg-3">
            <div class="card-tag h-100">
                <div class="sku-tag mb-2">TEAM</div>
    ...
    <div class="card-tag">
        ...
        <a href="{{ route('products.create') }}" class="btn btn-primary btn-sm me-2">+ Add Product</a>
        <a href="{{ route('inventory-transactions.create') }}" class="btn btn-primary btn-sm me-2">+ Record Transaction</a>
